...
int tela_menu(); //mostra a tela com o menu de opções - retorna a opção (um valor de 1 a 5) escolhida - retorna -1 caso o usuário escolha uma opção inválida
    ...
    do {
        ...
        switch(opcao)
        {
            ...
            case 2:
                ...
                if (total_alimento == 0) {
                    printf("\nNão há alimentos cadastrados para pesquisar!\n\n");
                    system("pause");
                    break;
                }
            ...
            case 3:
                // verifica se há algum alimento cadastrado
                if (total_alimento == 0) {
                    printf("\nNão há alimentos cadastrados para remover!\n\n");
                    system("pause");
                    break;
                }
